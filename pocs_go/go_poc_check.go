...
import (
	...
	"github.com/w3security/goscan/pocs_go/Springboot"
	"github.com/w3security/goscan/pocs_go/ThinkPHP"
	"github.com/w3security/goscan/pocs_go/apache"
	"github.com/w3security/goscan/pocs_go/confluence"
	"github.com/w3security/goscan/pocs_go/f5"
	"github.com/w3security/goscan/pocs_go/fastjson"
	"github.com/w3security/goscan/pocs_go/gitlab"
	"github.com/w3security/goscan/pocs_go/jboss"
	"github.com/w3security/goscan/pocs_go/jenkins"
	"github.com/w3security/goscan/pocs_go/landray"
	"github.com/w3security/goscan/pocs_go/log4j"
	"github.com/w3security/goscan/pocs_go/mcms"
	"github.com/w3security/goscan/pocs_go/ms"
	"github.com/w3security/goscan/pocs_go/phpunit"
	"github.com/w3security/goscan/pocs_go/seeyon"
	"github.com/w3security/goscan/pocs_go/shiro"
	"github.com/w3security/goscan/pocs_go/spark"
	"github.com/w3security/goscan/pocs_go/sunlogin"
	"github.com/w3security/goscan/pocs_go/tomcat"
	"github.com/w3security/goscan/pocs_go/tongda"
