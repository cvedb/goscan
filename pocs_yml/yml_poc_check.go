...
import (
	...
	xray_check "github.com/w3security/goscan/pocs_yml/check"
	common_structs "github.com/w3security/goscan/pocs_yml/pkg/common/structs"
	xray_requests "github.com/w3security/goscan/pocs_yml/pkg/xray/requests"
	"github.com/w3security/goscan/pocs_yml/utils"
)
