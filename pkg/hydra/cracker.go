...
import (
	...
	"github.com/w3security/goscan/pkg/hydra/elastic"
	"github.com/w3security/goscan/pkg/hydra/ftp"
	"github.com/w3security/goscan/pkg/hydra/mongodb"
	"github.com/w3security/goscan/pkg/hydra/mssql"
	"github.com/w3security/goscan/pkg/hydra/mysql"
	"github.com/w3security/goscan/pkg/hydra/oracle"
	"github.com/w3security/goscan/pkg/hydra/pop3"
	"github.com/w3security/goscan/pkg/hydra/postgresql"
	"github.com/w3security/goscan/pkg/hydra/rdp"
	"github.com/w3security/goscan/pkg/hydra/redis"
	"github.com/w3security/goscan/pkg/hydra/router"
	"github.com/w3security/goscan/pkg/hydra/smb"
	"github.com/w3security/goscan/pkg/hydra/snmp"
	"github.com/w3security/goscan/pkg/hydra/socks5"
	"github.com/w3security/goscan/pkg/hydra/ssh"
	"github.com/w3security/goscan/pkg/hydra/telnet"
	"github.com/w3security/goscan/pkg/hydra/vnc"
	"github.com/w3security/goscan/pkg/hydra/winrm"
	"github.com/w3security/goscan/pkg/kscan/core/slog"
	"github.com/w3security/goscan/pkg/kscan/lib/gotelnet"
	"github.com/w3security/goscan/pkg/kscan/lib/grdp"
)
