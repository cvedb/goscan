...
import (
	...
	"github.com/w3security/goscan/pkg/fingerprint"
	"github.com/w3security/goscan/pocs_go"
	"github.com/w3security/goscan/pocs_yml"
	...
	"github.com/w3security/goscan/pkg/httpx/common/hashes"

	customport "github.com/w3security/goscan/pkg/httpx/common/customports"
	fileutilz "github.com/w3security/goscan/pkg/httpx/common/fileutil"
	"github.com/w3security/goscan/pkg/httpx/common/httputilz"
	"github.com/w3security/goscan/pkg/httpx/common/httpx"
	"github.com/w3security/goscan/pkg/httpx/common/slice"
	"github.com/w3security/goscan/pkg/httpx/common/stringz"
...
retry:
	...
	if scanopts.VHostInput {
		...
		domain = parts[0]
		//util "github.com/w3security/goscan/pkg"
